...
public class DamageCalculations
{
	...
	// Damage is equivalent to the ability's power
	public static DamageResult FixedDamageFormula(Character attacker, Character defender, DamageAbility ability, IAbilityImpl parentAbility)
	{
		...
		result.amount = (int)(ability.Power(attacker, defender, ability, parentAbility) * effectiveness_multiplier);
		
		return result;
	}
	
	public static DamageResult CalculateDamage(Character attacker, Character defender, DamageAbility ability, IAbilityImpl parentAbility)
	{
		return CalculateDamage(attacker, defender, ability, parentAbility, new Random());
	}
	
	public static DamageResult CalculateDamage(Character attacker, Character defender, DamageAbility ability, IAbilityImpl parentAbility, Random generator)
	{
		DamageResult result = new DamageResult();
		...
		uint power = ability.Power(attacker, defender, ability, parentAbility);
