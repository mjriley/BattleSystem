...
public class AbilityFactory
{
	...
	public static void Init()
	{
		...
		AddAbility(new EffectAbility("Withdraw", AbilityType.Status, BattleType.Water, 40, BasicEffects.StatEffect(Target.Self, Stat.Defense, 1)));
		...
		AddAbility(new EffectAbility("Leech Seed", AbilityType.Status, BattleType.Grass, 10, BasicEffects.SeedTarget, 90));
		...
		AddAbility(new MultiHitAbility("Fury Swipes", AbilityType.Physical, BattleType.Normal, 15, 18, 80, 2, 5, distribution_gen: new FiveHitDistribution()));
		...
		AddAbility(new DamageAbility("Flail", AbilityType.Physical, BattleType.Normal, 15, new GatedPercentHP(), 100));
		...
		AddAbility(new EffectAbility("Growl", AbilityType.Status, BattleType.Normal, 40, BasicEffects.StatEffect(Target.Enemy, Stat.Attack, -1)));
		AddAbility(new EffectAbility("Tail Whip", AbilityType.Status, BattleType.Normal, 30, BasicEffects.StatEffect(Target.Enemy, Stat.Defense, -1)));
		AddAbility(new EffectAbility("Howl", AbilityType.Status, BattleType.Normal, 40, BasicEffects.StatEffect(Target.Self, Stat.Attack, 1)));
		AddAbility(new EffectAbility("Agility", AbilityType.Status, BattleType.Psychic, 30, BasicEffects.StatEffect(Target.Self, Stat.Speed, 2)));
		AddAbility(new EffectAbility("Leer", AbilityType.Status, BattleType.Normal, 30, BasicEffects.StatEffect(Target.Enemy, Stat.Defense, -1)));
		...
		AddAbility(new EffectAbility("Smokescreen", AbilityType.Status, BattleType.Normal, 20, BasicEffects.StatEffect(Target.Enemy, Stat.Accuracy, -1)));
		// TODO: Look into how it always hits
		AddAbility(new EffectAbility("Play Nice", AbilityType.Status, BattleType.Normal, 20, BasicEffects.StatEffect(Target.Enemy, Stat.Attack, -1)));
		
		AddAbility(new RepeatAbility(new DamageAbility("Rollout", AbilityType.Physical, BattleType.Rock, 20, new PowerPerTurn(30), 90), 5));
		
		AddAbility(new DamageAbility("Dragon Rage", AbilityType.Special, BattleType.Dragon, 10, 40, 100, damageFormula: DamageCalculations.FixedDamageFormula));
