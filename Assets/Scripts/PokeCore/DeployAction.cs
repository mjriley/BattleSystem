...
// This could probably be combined with the SwapAction
public class DeployAction : ITurnAction
{
	Player m_player;
	Character m_subject;
	int m_newIndex;
	...
	public DeployAction(Player player, int newIndex, bool friendly)
	{
		m_player = player;
		m_newIndex = newIndex;
		m_friendly = friendly;
	...
	public string Name { get { return "DeployAction"; } }
